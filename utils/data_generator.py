...
def main():
    ...
    if kind=="normal":
        run(count,pkt, username, password, "normal", "../data/raw/normal/", targetIP, "success")
    else:
        p = random.random()
        if p>0.1:
            run(count,pkt, username, password, "brute", "../data/raw/brute/", targetIP, "fail")
        else:
            run(count,pkt, username, password, "brute", "../data/raw/brute/", targetIP, "success")
